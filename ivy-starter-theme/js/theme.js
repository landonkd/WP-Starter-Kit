...
ready(() => { 
	...
	window.addEventListener('scroll', function () {
		...
		// Add desired animation to every element that has class .animate__animated 
		document.querySelectorAll('.animate__animated').forEach(item => {

			var itemY = item.offsetTop - window.innerHeight;
			if (isMobile) {
				//itemY = itemY - 150;
			}

			if (window.scrollY > itemY) {
