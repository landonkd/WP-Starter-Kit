			...
			<div class="site-branding">
				<div itemscope="itemscope" itemtype="http://schema.org/Organization">
					<a itemprop="url" href="/" title="">
						<span class="site-title">Ivy Group</span>
						<img class="logo" itemprop="logo" src="/wp-content/themes/ivy-starter-theme/images/logo.png" alt="Organization Logo" class="desktop-logo">
					</a>
				</div>
			</div><!-- .site-branding -->
